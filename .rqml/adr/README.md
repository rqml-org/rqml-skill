...
| [0002](0002-bundle-schemas-instead-of-fetching-them.md) | Bundle XSDs in the skill instead of fetching at runtime | Accepted |
| [0003](0003-validation-tool-fallback-chain.md) | Validation uses an `xmllint → lxml → xmlschema` fallback chain | Accepted |
| [0004](0004-python-as-script-language.md) | Scripts are written in Python 3.8+ | Accepted |
| [0005](0005-auto-detect-schema-version.md) | Schema version is auto-detected from `rqml@version` | Accepted |
| [0006](0006-mirror-rqml-docs-instead-of-duplicating.md) | References mirror, not duplicate, the canonical RQML docs | Accepted |
| [0007](0007-strictness-is-runtime-config.md) | Strictness level is read at runtime from project config | Accepted |
